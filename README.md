...
This project proves mastery of the following learning objectives:
...
- Presentation in PDF format named "presentation.pdf" and included in the code repository root folder. 
